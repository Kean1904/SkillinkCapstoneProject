    ...
    <div class="page-content">
        ...
        <div class="page-inner">
            ...
            <div class="page-title">
                <span><i class="fa-solid fa-user"></i> ADMINISTRATOR PROFILE</span>
            ...
            <div class="card" style="display: flex; gap: 25px; align-items: center; flex-wrap: wrap;">
                <img src="{{ asset('image/MP_Profile.png') }}" alt="Profile" style="width: 90px; height: 90px; border-radius: 50%; background: white; padding: 5px; border: 3px solid #ef4444;">
                <div>
                    <h2 style="font-size: 22px; margin-bottom: 4px;">{{ $user->full_name }}</h2>
                    <p style="font-size: 13px; color: #93c5fd; margin-bottom: 8px;">@ {{ $user->name }} &bull; System Administrator</p>
                    <span style="background: #ef4444; color: white; padding: 3px 10px; border-radius: 12px; font-size: 12px; font-weight: bold;">
                        <i class="fa-solid fa-shield-halved"></i> Root Administrator Authority
                    </span>
                </div>
            </div>
            ...
            <!-- DETAILS GRID -->
            <div class="card">
                <h3><i class="fa-solid fa-server"></i> System Authority Details</h3>
                <hr>
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 18px; font-size: 14px;">
                    <div><span style="opacity: 0.7; font-size: 12px; display: block;">ADMIN EMAIL</span><strong>{{ $user->email }}</strong></div>
                    <div><span style="opacity: 0.7; font-size: 12px; display: block;">CONTACT NUMBER</span><strong>{{ $user->contact_number }}</strong></div>
                    <div><span style="opacity: 0.7; font-size: 12px; display: block;">OFFICIAL STATION</span><strong>Municipal Hall Complex, Magalang</strong></div>
                    <div><span style="opacity: 0.7; font-size: 12px; display: block;">ACCESS LEVEL</span><strong style="color: #4ade80;">Super Admin (Unrestricted)</strong></div>
                </div>
            </div>
