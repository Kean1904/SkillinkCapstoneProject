...
<head>
    <meta charset="UTF-8">
    <title>SKILLINK - Client Settings</title>
    ...
    <div class="page-content">
        ...
        <div class="page-inner" style="max-width: 760px;">
            ...
            <div class="card" style="background: rgba(30, 58, 138, 0.35); border: 1px solid rgba(255,255,255,0.2); border-radius: 14px; padding: 20px; margin-bottom: 18px;">
                ...
                <div class="settings-row" onclick="openModal('passwordModal')">
                    <div>
                        ...
                        <p class="row-sub">Update your account login password</p>
                    </div>
                    <i class="fa-solid fa-chevron-right" style="opacity: 0.6; font-size: 13px;"></i>
                </div>
                <div class="settings-row" style="cursor: default;">
                    <div>
                        <p class="row-title">Account Status</p>
                        <p class="row-sub">Verified resident in Magalang</p>
                    </div>
                    <span style="background: #10b981; color: white; padding: 3px 10px; border-radius: 10px; font-size: 11px; font-weight: bold;">Verified Citizen</span>
                </div>
            </div>
            ...
            <div class="card" style="background: rgba(30, 58, 138, 0.35); border: 1px solid rgba(255,255,255,0.2); border-radius: 14px; padding: 20px; margin-bottom: 18px;">
                ...
                <div class="settings-row" style="cursor: default;">
                    <div>
                        <p class="row-title">Job & Service Alerts</p>
                        <p class="row-sub">Receive alerts for worker updates and job responses</p>
                    </div>
                    <label class="switch">
                ...
                <div class="settings-row" style="cursor: default;">
                    <div>
                        ...
                        <p class="row-sub">Updates on PESO job fairs, SPES, and programs</p>
                    </div>
                    <label class="switch">
                        <input type="checkbox" checked>
                        <span class="slider"></span>
            ...
            <div class="card" style="background: rgba(30, 58, 138, 0.35); border: 1px solid rgba(255,255,255,0.2); border-radius: 14px; padding: 20px; margin-bottom: 18px;">
                ...
                <div class="settings-row" onclick="openModal('privacyModal')">
                    <div>
                        ...
                        <p class="row-sub">How PESO Magalang protects citizen records</p>
                    </div>
                    <i class="fa-solid fa-chevron-right" style="opacity: 0.6; font-size: 13px;"></i>
                </div>
                <div class="settings-row" onclick="openModal('termsModal')">
                    <div>
                        <p class="row-title">Terms of Service</p>
                        <p class="row-sub">Rules for workers, employers, and clients</p>
                    </div>
                    <i class="fa-solid fa-chevron-right" style="opacity: 0.6; font-size: 13px;"></i>
                </div>
            </div>
            ...
            <div class="card" style="background: rgba(30, 58, 138, 0.35); border: 1px solid rgba(255,255,255,0.2); border-radius: 14px; padding: 20px;">
                ...
                <div class="settings-row" style="cursor: default;">
                    <div>
                        ...
                        <p class="row-sub">Telephone support for Magalang residents</p>
                    </div>
