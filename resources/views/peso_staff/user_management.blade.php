...
<head>
    <meta charset="UTF-8">
    <title>SKILLINK - PESO Staff User Management</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: Arial, sans-serif; }
        ...
        .sidebar {
            ...
            background: #0033a0; z-index: 2000; transition: left 0.3s ease; padding-top: 65px;
            box-shadow: 2px 0 10px rgba(0,0,0,0.35); display: flex; flex-direction: column; overflow-y: auto;
        }
        .sidebar.active { left: 0; }
        .sidebar-profile {
            display: flex; flex-direction: column; align-items: center; padding: 15px 15px 10px 15px;
            border-bottom: 1px solid rgba(255,255,255,0.2); margin-bottom: 6px; flex-shrink: 0;
        }
        .sidebar-avatar, .sidebar-profile img {
            width: 54px; height: 54px; border-radius: 50%; background: white; padding: 3px;
            margin-bottom: 6px; box-shadow: 0 2px 6px rgba(0,0,0,0.25); object-fit: cover;
        }
        .sidebar-avatar-fallback {
            width: 54px; height: 54px; border-radius: 50%; background: rgba(255,255,255,0.2);
            border: 2px solid rgba(255,255,255,0.8); display: flex; align-items: center; justify-content: center;
            margin-bottom: 6px; color: white; font-size: 24px;
        }
        .sidebar-profile .name { color: white; font-weight: bold; font-size: 13.5px; text-align: center; line-height: 1.3; }
        .sidebar-profile .role { margin-top: 3px; text-align: center; }
        .role-badge { background: #10b981; color: white; padding: 2px 8px; border-radius: 4px; font-size: 9.5px; font-weight: bold; display: inline-block; letter-spacing: 0.5px; }

        .sidebar-menu { list-style: none; padding: 2px 0; margin: 0; flex: 1; }
        .sidebar-menu li a {
            display: flex; align-items: center; gap: 10px; color: white; text-decoration: none;
            padding: 8px 18px; font-size: 13px; font-weight: 500; transition: background 0.2s, padding-left 0.2s;
            border-left: 3px solid transparent;
        }
        .sidebar-menu li a:hover, .sidebar-menu li a.active {
            background-color: rgba(255, 255, 255, 0.15); border-left-color: #60a5fa; color: #ffffff;
            font-weight: 700; padding-left: 22px;
        }
        .sidebar-menu li a i { width: 18px; text-align: center; font-size: 13.5px; }

        .sidebar-footer { padding: 10px 14px 14px 14px; border-top: 1px solid rgba(255,255,255,0.2); flex-shrink: 0; }
        .logout-btn {
            display: flex; align-items: center; justify-content: center; gap: 8px; width: 100%;
            padding: 8px; background: rgba(239, 68, 68, 0.25); color: #fca5a5; border: 1px solid #ef4444;
            border-radius: 6px; text-decoration: none; font-size: 12px; font-weight: 700; transition: all 0.2s;
        }
...
<body>
    ...
    <div class="header">
        <div class="header-left">
            ...
            <div>
                <h1>SKILLINK</h1>
                <p>Public Employment Service Office — Magalang, Pampanga</p>
            </div>
        </div>
    </div>

    <!-- PESO STAFF SIDEBAR -->
    @include('partials.sidebar_peso_staff', ['active' => 'users'])
    ...
    <div class="page-content">
        ...
        <div class="page-inner">
            ...
            <div class="page-title">
                <span><i class="fa-solid fa-users"></i> PESO USER & CONSTITUENT DIRECTORY</span>
                <a href="{{ route('dashboard.PesoStaff') }}" class="back-link">&larr; Back to PESO Dashboard</a>
            </div>

            <div class="card">
                <h3><i class="fa-solid fa-id-card-clip"></i> Registered Citizens & Active App Monitoring</h3>
                <p style="font-size: 13px; opacity: 0.85;">Subaybayan ang mga mamamayan kung kailan ginawa ang kanilang account at kung sino ang kasalukuyang aktibong gumagamit ng application.</p>
                <hr>
